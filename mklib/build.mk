...
DIST_EXT := tar
ifdef REDHAT
BUILD_DEPENDS = cmake autoconf imake patch gcc gcc-c++ git psutils texinfo uuid-devel libuuid libuuid-devel pam-devel libaio-devel libaio glibc-devel compat-glibc rpm-build
...
LINK_FLAGS     = LIBRARY_PATH="$(LIBRARY_PATH)" LD_LIBRARY_PATH="$(LD_LIBRARY_PATH)" LD_RUN_PATH="$(LD_RUN_PATH)" LDFLAGS="$(LDFLAGS) $(LIBS)" LIBS="$(LIBS)" $(LINK_EXTRA_FLAGS) 
